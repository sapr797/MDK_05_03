...
- [ ] Тест стратегии override
- [ ] Тест стратегии skip
- [ ] Тест стратегии error (без конфликта)
- [ ] Тест стратегии error (с конфликтом)
- [ ] Тест стратегии merge_lists (оба списки)
- [ ] Тест стратегии merge_lists (один не список)
- [ ] Тест стратегии merge_lists (оба не списки)
...
- [ ] Тест с сохранением порядка
- [ ] Тест с TypeError (не список)
- [ ] Тест с TypeError (элемент не словарь)
- [ ] Тест с KeyError (ключ не найден)
...
- [ ] Тест с чанками
- [ ] Тест с пустым списком
- [ ] Тест с chunk_size больше списка
- [ ] Тест с chunk_size = 1
- [ ] Тест с TypeError (items)
- [ ] Тест с TypeError (chunk_size)
- [ ] Тест с ValueError (chunk_size <= 0)

### count_frequencies (цель: 100%)
- [ ] Тест с различными элементами
- [ ] Тест с повторяющимися элементами
- [ ] Тест с пустым списком
- [ ] Тест с TypeError
Задание 3.4. Финальный запуск и анализ (10 минут)
bash
# Финальный запуск со всеми опциями
pytest --cov=collection_manager --cov-report=term --cov-report=html --cov-report=xml --cov-branch --cov-fail-under=90
...
Следующее занятие: Контрольная работа 3.2 по темам 3.6–3.9.
